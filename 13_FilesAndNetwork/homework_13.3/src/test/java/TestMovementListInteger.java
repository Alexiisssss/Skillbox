...
@DisplayName("Файл test/src.main.src.main.resources/movementListInteger.csv (значения целые)")
public class TestMovementListInteger {
    ...
    private String getCsvFilenamePath() {
        return new File(Objects.requireNonNull(this.getClass().getResource(CSV_FILENAME)).getPath()).getAbsolutePath();
    }
